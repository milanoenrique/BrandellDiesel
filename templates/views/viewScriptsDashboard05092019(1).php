                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value){
                                                    ...
                                                    if(row.assignedto!=null){
                                                        if(value!=null){
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure' placeholder='Estimated Date' value="+value+"> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";        
                                                        }else{
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure' placeholder='Estimated Date'> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";
