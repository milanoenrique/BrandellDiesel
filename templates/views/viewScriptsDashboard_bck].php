    		...
    		call_Ajax_Jsonp(URL, METODO, VALOR, LOADER, ERROR, function(data){
                ...
                $('#table-dashboard').bootstrapTable({
                                ...
                                formatter : function(value, row)
                                {
                                    ...
                                    if (value === "Y"){
                                         if(row.status==='ordered'){
                                            return '<a class="blink"><span class="fa fa-circle" aria-hidden="true" style="color:blue;"></span></a>';    
                                        }
                                        if(row.status==='Ordered Delay'){
                                            return '<a class="blink"><span class="fa fa-circle" aria-hidden="true" style="color:#ea8108;"></span></a>';    
                                        }else{
                                            return '<a class=""><span class="fa fa-circle" aria-hidden="true" style="color:yellow;"></span></a>';
                                        }
                                    ...
                                    if(value==='O'){
                                        return '<a class=""><span class="fa fa-circle" aria-hidden="true" style="color:blue;"></span></a>';
                                    }
                                    if(value==='RI'){
                                        if(row.status==='ordered'){
                                            return '<a class=""><span class="fa fa-circle" aria-hidden="true" style="color:blue;"></span></a>';    
                            ...
                            <?php if ($profile != 'TV'): ?>
                                <?php if ($profile != 'TECH'): ?>
                                    {
                                        ...
                                        formatter : function(value, row)
                                        {
    										...
    										if (row.status === "Closed" || row.status ==='Quoted') {
                                ...
                                <?php if ($profile != 'TECH'): ?>
                                    ...
                                    },*/
                                    {
                                        ...
                                        clickToSelect: false,
                                        formatter:function(value,row){
                                            var vdetails = '<a class=""><span class="fa fa-list-ul" aria-hidden="true"></span></a>';
                    ...
                    onClickCell: function (field, value, row){
                        ...
                        if (field === "assign" && row.status != "Closed" && row.status != "Quoted"){
                        ...
                        }else if(field === "edit" && row.status != "Closed" && row.status != "Quoted"){
                              //console.log(row);
                              idpriority = row.idpriority;
                            var assignedto = row.assignedto;
                            flag_chance=false;
                                                    ...
                                                    //console.log("select: "+JSON.stringify(parts));
                                                        ...
                                                        if(assignedto!=null){
                                                            ...
                                                            if($('#quote').is(':checked')){
                                                                    ...
                                                                    text = '<select id='+parts[index_part].part+' class="status_part secure "><option value="quoted">Quoted</option><option value="In-Stock">In-Stock</option></select>';
                                                                    $('#global-status-part option[value=received]').hide()
                                                                    $('#global-status-part option[value=quoted]').show()
                                                            ...
                                                            if(parts[index_part].ord=='quoted'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part secure "><option value="quoted" selected="true">Quoted</option><option value="ordered">Ordered</option><option value="In-Stock">In-Stock</option></select>';
                                                            }

                                                            if(parts[index_part].ord=='In-Stock'){
                                                                text = '<select id='+parts[index_part].part+' class="status_part secure "><option value="quoted" >Quoted</option><option value="ordered">Ordered</option><option value="In-Stock" selected="true">In-Stock</option></select>';
                                                            }
                                                            ...
                                                            if(parts[index_part].ord=='ordered'){
                                                                ...
                                                                if(parts[index_part].ord=='received'){
                                                                    text = '<select id='+parts[index_part].part+' class="status_part secure "><option value="ordered">Ordered</option><option value="received" selected="true">Received</option><option value="In-Stock">In-Stock</option>';
                                                                }

                                                                if(parts[index_part].ord=='In-Stock'){
                                                                    text = '<select id='+parts[index_part].part+' class="status_part secure "><option value="received" >Received</option><option value="ordered">Ordered</option><option value="In-Stock" selected="true">In-Stock</option></select>';
                                                                }
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value, row){
                                                    ...
                                                    if(assignedto!=null){
                                                        if(value!=null){
                                                          if(row.status=='ordered'){
                                                            text = "<div class='col-lg-12  input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure lock' placeholder='Estimated date' value="+value+"></div>";
                                                            ...
                                                            if(row.status=='ordered'){
                                                                text = "<div class='col-lg-12  input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure lock' placeholder='Estimated date'></div>";
                                                            }else{
...
console.log('I-2');
                        ...
                        }else if(field === "delete" && row.status != "Closed" && row.status !="Quoted"){
                            ...
                            if (row.status.toLowerCase()!='quoted') {
                                $('#modal-delete').modal('show');
                            } else {
                                alert('You are trying to delete an request that it is quoted.');
                            }
                        ...
                        function(){
                            ...
                            call_Ajax_Jsonp(URL, METODO, VALOR, LOADER, ERROR, function(data){
                                ...
                                $.each(COLORS, function(index)
                                {
                                    ...
                                    else if (COLORS[index].colorflag === "RI")
                                    {
                                        $("#RI").text(" " + COLORS[index].quantity);
                                    }
        					    });
                            });
                        },
    		...
    		$(function (){
                ...
                $(document).on("dp.show", '.fixdate', function () {
                    if (window.innerWidth < 1200 && window.innerWidth > 768) {
                        $(this).closest('.fixed-table-container').attr('style', 'position: absolute;z-index: 99;background-color: #fff;left: -6%;');
                        $(this).closest('.fixed-table-body').attr('style', 'overflow:visible!important;');
                    }
                    if (window.innerWidth < 768 && window.innerWidth > 600) {
                        $(this).closest('.fixed-table-container').attr('style', 'position: absolute;z-index: 99;background-color: #fff;left: -' + Math.abs(($(this).closest('table').position().left + $(this).closest('td').position().left) - 100) + 'px;');
                        $(this).closest('.fixed-table-body').attr('style', 'overflow:visible!important;');
                    }
                    if (window.innerWidth < 600) {
                        $(this).closest('.fixed-table-container').attr('style', 'position: absolute;z-index: 99;background-color: #fff;left: -' + Math.abs(($(this).closest('table').position().left + $(this).closest('td').position().left) - 50) + 'px;');
                        $(this).closest('.fixed-table-body').attr('style', 'overflow:visible!important;');
                    }
                });
                $(document).on("dp.hide", '.fixdate', function () {
                    if (window.innerWidth < 1200) {
                        $(this).closest('.fixed-table-container').attr('style', '');
                        $(this).closest('.fixed-table-body').attr('style', '');
                    }
                });
					...
					/*call_Ajax_Jsonp(URL, METODO, VALOR, LOADER, ERROR, function(data){
						...
						if(DATA){
							...
							rederizsoftReady('A','#partsRequesition', 'common/sendMail.php?vRo='+encodeURIComponent(ro)+'&vtechName='+encodeURIComponent(techName)+'&vPriority='+encodeURIComponent(vPriority)+'&vType='+encodeURIComponent(vType)+'&vVin='+encodeURIComponent(vin)+'&vComments='+encodeURIComponent(comments)+'&vpartsJSON='+encodeURIComponent(partsJSON)+'&vDate='+encodeURIComponent(moment(DATE).format("MMM DD YYYY, hh:mm:ss a"))+'&vEngine='+encodeURIComponent(engine)+'&vID='+encodeURIComponent(idrequest)+'&vStatus=', '#cargar_data_requesition', 'consultar');
                               ...
                               setTimeout(print_service(idrequest,ro), 5000);
							if(parts.length !== 0){
								DATA        = null;
								METODO      = "request_parts_insert";
								partsJSON   = JSON.stringify(parts);
			...
			$("#modal-edit #buttonSave").click(function(event){
                ...
                if(parts.length==0){
                    ...
                    $('#table-parts .status_part').each(function(){
                        ...
                        var status_part_edit = $('#'+part_edit+' option:selected').val();
                      ...
                      array_deleted.forEach(function(element){
                            array_edit.push(element);
                        });

                            if(array_edit.length==0){
                                   $('#table-parts .comments_parts').each(function(){
                                        var id_aux;
                                        id_aux = $(this).prop('id');
...
console.log('I3');
                ...
                call_Ajax_Jsonp(URL, METODO, VALOR, LOADER, ERROR, function(data){
                    ...
                    $('#modal-adminUsers #table-userDashboard').bootstrapTable({
                        ...
                        onClickCell: function (field, value, row){
                            ...
                            $("#modal-deluser #buttonCloseDeleteUser").click(function(){
       ...
       $('#modal-edit #table-parts ,secure').change(function(){
        $(".modal-footer #buttonSave").removeAttr('disabled');
        flag_chance=true;

    });

          $('.secure').keypress(function(){
        $(".modal-footer #buttonSave").removeAttr('disabled');
            flag_chance = true;
    });

       $('#modal-edit #table-parts ,secure').keyup(function(){
        $(".modal-footer #buttonSave").removeAttr('disabled');
...
function close_modal(){
    if(flag_chance==true){
        var option = confirm("Will you lose all the changes made, do you want to continue?");
    if (option == true) {
             $('#myModalPartsRequesition').modal('hide');
             flag_chance = false;
    } else {
...
function print_service(id, ro){
     $.ajax({
                                    url:'common/print_pdf.php',
                                    type:'POST',
                                    data: {'id':id,
                                           'ro': ro}
                                });
...
function send_post(url,data,fn){
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'JSON',
            ...
            alert('Please insert a date valid.');
               ...
               $('#modal-edit .check-part').each(function(){
                    ...
                    if( $(this).prop('checked') ) {
                        ...
                        //if(($('#'+$(this).val()+'').val()!='received') && ($('#'+$(this).val()+'').val()!='In-Stock') && ($('#'+$(this).val()+'').val()!='quoted') )
                        //{
                            json_edit = {
                                            "comment_parts":comment_part_edit, 
                                            "status_order":status_part_edit, 
                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value){
                                                            ...
                                                            if(value=='quoted'||parts[index_part].ord=='In-Stock'){
                                                            ...
                                                            return '<select id='+value+' class="status_part"><option value="">Select an option</option><option value="ordered">Ordered</option><option value="received">Received</option><option value="In-Stock">In-Stock</option></select>';
