                                        ...
                                        [
                                            ...
                                            },
                                            {
                                                ...
                                                formatter: function(value,row){
                                                    ...
                                                    if(assignedto!=null){
                                                        if(value!=null){
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure' placeholder='Date of Delivery' value="+value+"> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";        
                                                        }else{
                                                            text = "<div class='col-lg-10 input-group date'><input type='text' id=part-"+parts[index_part].part+" disabled class='form-control fixdate secure' placeholder='Date of Delivery'> <span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></div>";
                                             ...
                                             if(field === "delete")
                                        {
                                            ...
                                            index_part= -1;
                                                ...
                                                if(newParts.length==0){
                                                    alert("A request must have at least a part; the changes will not be saved, if the request is empty...");
                                            ...
                                            $('#modal-edit').on('change','select.status_part', function(e){
                                                ...
                                                if($(this).val()=='ordered'){
                                                    ...
                                                    if ($(this).val()=='received' || $(this).val()=='quoted') {
                                                        add_class='true'
                                                        $('#part-'+$(this).attr('id')).prop('disabled',false);
                                                        $('#part-'+$(this).attr('id')).attr('placeholder', 'Real date');
           ...
           $('#tab-parts').click(function(){
			...
			$("#modal-edit #buttonSave").click(function(event){
                if(parts.length==0){
                    ...
                    var id_aux;
                    id_aux = $(this).prop('id');
                    id_aux=id_aux.replace('c-','h-');
                    if( $(this).val()!=$('#'+id_aux).val()){
                        comment_canceled.push({'part' : $(this).prop('id'), 'comment' : $(this).val()});
                ...
                if ($('#part-'+element).val()=='' && $('#'+element).val()==='ordered'){
                   z++;
                     ...
                     if ($('#part-'+element).val()=='' && $('#'+element).val()==='received'){
                   z++;

                }else{
                     if ($('#part-'+element).val()!='' && ($('#'+element).val()==='received')|| $('#'+element).val()==='quoted'){
                        real_date.push({'part':element, 'real_date': $('#part-'+element).val() });
                ...
                if ($('#part-'+element).val()=='' && $('#'+element).val()==='quoted'){
                   z++;
                    ...
                    if (z>0){
                        ...
                        alert("The Date of Delivery it's require for parts with status ordered, received or quoted");   
              ...
              //  console.log(partsJSON);
                ...
                METODO          = partsJSON;
                VALOR           = idrequest + "|" + jobnumber + "|" + appuser + "|" + idrequesttype + "|" + idpriority + "|" + ro + "|" + vin + "|" + trans + "|" + engine + "|" + comments + "|"  + JSON.stringify(real_date);
                real_date=[];
                call_Ajax_Jsonp(URL, METODO, VALOR, LOADER, ERROR, function(data){
                    DATA = data;
                    //console.log(parts);
                 ...
                 if(ro!=compare_order.ro || vin!=compare_order.vin || comments!=compare_order.comments || engine != compare_order.engine || parts.length !=compare_order.parts || delete_flag == true ){
